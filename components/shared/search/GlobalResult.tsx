...
const GlobalResult = () => {
  ...
  const [result, setResult] = useState([
    { type: "question", id: "1", title: "How to create a new project" },
    { type: "tag", id: "2", title: "nextjs" },
    { type: "question", id: "3", title: "jsm" },
  ]);
  ...
  return (
    ...
    >
      <GlobalFilters />
      <div
        className="my-5 h-px bg-light-700/50 
    dark:bg-dark-500/50"
      />
          ...
          <div className="flex flex-col gap-2">
            {result.length > 0 ? (
              result.map((item: any, index: number) => (
                ...
                gap-3 px-5 py-2.5 hover:bg-light-700/50
                dark:hover:bg-dark-500/50"
                >
                  <Image
